...
INSERT INTO products (id, name, description, price, stock, category, tags, rating, reviews_count, image_url, organic, active) VALUES
  ('00000000-0000-0000-0000-000000000001', 'Detox Green Supreme',
   ...
   'https://images.unsplash.com/photo-1622597467836-f3285f2131b8?w=400&h=400&fit=crop', TRUE, TRUE),
  ...
  ('00000000-0000-0000-0000-000000000002', 'Vitamina C + Zinc Orgánico',
   ...
   'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=400&h=400&fit=crop', TRUE, TRUE),
  ...
  ('00000000-0000-0000-0000-000000000003', 'Proteína Vegetal Premium',
   ...
   'https://images.unsplash.com/photo-1593095948071-474c5cc2c4d8?w=400&h=400&fit=crop', TRUE, TRUE),
  ...
  ('00000000-0000-0000-0000-000000000004', 'Colágeno Marino Hidrolizado',
   ...
   'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=400&h=400&fit=crop', FALSE, TRUE),
  ...
  ('00000000-0000-0000-0000-000000000005', 'Té Detox Nocturno',
   ...
   'https://images.unsplash.com/photo-1544787219-7f47ccb76574?w=400&h=400&fit=crop', TRUE, TRUE),
  ...
  ('00000000-0000-0000-0000-000000000006', 'Multivitamínico Natural',
   ...
   'https://images.unsplash.com/photo-1550572017-edd951aa8f72?w=400&h=400&fit=crop', TRUE, TRUE),
  ...
  ('00000000-0000-0000-0000-000000000007', 'Aceite de Coco Virgen Extra',
   ...
   'https://images.unsplash.com/photo-1526947425960-945c6e72858f?w=400&h=400&fit=crop', TRUE, TRUE),
  ...
  ('00000000-0000-0000-0000-000000000008', 'Colágeno + Biotina Beauty',
   ...
   'https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?w=400&h=400&fit=crop', FALSE, TRUE);
