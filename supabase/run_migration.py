...
TOKEN = "sbp_4c004da70f0dd675f4bd1a4a9cd24c7f91d4583c"
PROJECT = "llabtbikofbbkongilqg"
...
$$ LANGUAGE plpgsql SECURITY DEFINER SET search_path TO 'public';
"""),
    ("PASO 5b — DROP + CREATE trigger trg_commissions_on_delivery", """
...
print("\n" + ("=== MIGRACION COMPLETADA ===" if all_ok else "=== ALGUNAS FALLAS — REVISION NECESARIA ==="))
